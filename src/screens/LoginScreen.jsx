...
export function LoginScreen({ onLogin }) {
    ...
    if (loading) {
        return (
            <div data-screen-label="00 Login" style={{ background: "#fff", display: "flex", flexDirection: "column", height: "100vh", width: "100vw", alignItems: "center", justifyContent: "center" }}>
                <style>{`
