            ...
            <div className={`panel-left ${lCol ? "collapsed" : ""}`}>
                {lCol ? (
                    <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", padding: "16px 0", gap: 16 }}>
                        <div onClick={() => setLCol(false)} style={{ cursor: "pointer", color: "var(--c-text-mute)", padding: 4 }}>{Icon.chevRight({ s: 16 })}</div>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", flex: 1, minWidth: 320, overflow: "hidden" }}>
                        <div style={{ padding: "12px 16px", borderBottom: "0.5px solid var(--c-border-faint)", display: "flex", alignItems: "center", gap: 10 }}>
                            ...
                            <div onClick={() => setLCol(true)} style={{ cursor: "pointer", color: "var(--c-text-mute)", padding: 4 }}>{Icon.chevLeft({ s: 16 })}</div>
                        </div>
                        {state === "ready" && <div>
